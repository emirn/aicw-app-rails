...
import { ShareClickTrendData } from "@/hooks/use-share-clicks-timeseries";
import { format } from "date-fns";
import { TrendingUp, Share2 } from "lucide-react";

interface ShareTrendChartProps {
    ...
    <Card>
        ...
        <div className="flex items-center justify-between">
          <div>
            <div className="flex items-center gap-2">
              ...
              <CardTitle>Share Clicks Over Time</CardTitle>
            </div>
            <p className="text-sm text-muted-foreground mt-1">
              Daily share button clicks trend
            </p>
          </div>
      ...
      <CardContent>
        <ResponsiveContainer width="100%" height={300}>
          ...
          >
            <defs>
              <linearGradient id="colorShareClicks" x1="0" y1="0" x2="0" y2="1">
                <stop offset="5%" stopColor="hsl(142, 76%, 36%)" stopOpacity={0.5} />
                <stop offset="95%" stopColor="hsl(142, 76%, 36%)" stopOpacity={0} />
              </linearGradient>
              <linearGradient id="colorShareSessions" x1="0" y1="0" x2="0" y2="1">
            ...
            <Tooltip
              content={({ active, payload }) => {
                if (active && payload && payload.length) {
                  const data = payload[0].payload as ShareClickTrendData;
                  return (
                      ...
                      <div className="space-y-1">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-sm font-semibold">
                            Shares: {data.clicks.toLocaleString()}
                          </span>
                        </div>
                        <div className="flex items-center gap-2">
                          <div
